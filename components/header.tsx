  ...
  return (
    <header className="sticky top-0 z-20 border-b border-wadeal-line bg-white/95 px-4 pb-3 pt-3 backdrop-blur">
      <div className="flex items-center gap-3">
        <div className="shrink-0 text-[22px] font-black tracking-[-0.02em] text-wadeal-red">
          Wadeal
        </div>
        <label className="flex h-10 min-w-0 flex-1 items-center gap-2 rounded-full bg-gray-100 px-3 text-gray-500">
